...
var GUI_debt_bar_scene = preload("res://scenes/GUI_debt_bar.tscn")
...
func _ready() -> void:
	...
	debt_bar = GUI_debt_bar_scene.instantiate()
	...
	canvas_layer.add_child(debt_bar)
